<html>
    <head>
        <link rel="stylesheet" href="whitecarnationdesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="white-carnations-cane-basket-arrangement_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="white-carnations-cane-basket-arrangement_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="white-carnations-cane-basket-arrangement_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="white-carnations-cane-basket-arrangement_3.webp" onmouseover="preview(this)"/></li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">White Carnations</div><br><br><br>
          ...
          112 Reviews</div><br>
          <div class="price">₹<div class="number">1150</div></div>
          <div class="discount"><del>₹1250</del></div>
          <div class="percent">8% discount</div>
          <br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>15 White Carnations</li>
                <li>Seasonal Green Fillers</li>
                <li>One Cane Basket</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>For over 400 years, carnations are even used to add flavour to different liquors, beers and wines</li>
                <li>Carnations have long life while blooming, and even after they are cut, these flowers tend to sustain for longer periods of time</li>
              </ul>
            </div>
          </fieldset>
        </div>
