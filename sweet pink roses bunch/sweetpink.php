<html>
    <head>
        <link rel="stylesheet" href="sweetpinkdesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="sweet-pink-roses-bunch_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="sweet-pink-roses-bunch_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <ii><img id="2" class="thumb_normal" src="sweet-pink-roses-bunch_2.webp" onmouseover="preview(this)"/></ii>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Sweet Pink Roses Bunch</div><br><br><br>
          ...
          222 Reviews</div><br>
          <div class="price">₹<div class="number">1350</div></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>16 Baby Pink Roses</li>
                <li>Wrapped in Jute</li>
                <li>Tied with White Raffia</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                ...
                <li>To deliver the poetic romance and gentleness, delicate pink roses are used</li>
              </ul>
            </div>
          </fieldset>
        </div>
