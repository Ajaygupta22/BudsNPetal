<html>
    <head>
        <link rel="stylesheet" href="orchiddesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="yellow-carnations-orchids-in-vase_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="yellow-carnations-orchids-in-vase_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="yellow-carnations-orchids-in-vase_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="yellow-carnations-orchids-in-vase_3.webp" onmouseover="preview(this)"/></li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Carnations & Orchids</div><br><br><br>
          ...
          102 Reviews</div><br>
          <div class="price">₹<div class="number">1710</div></div>
          <div class="discount"><del>₹1899</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Most orchids bloom once a year, but if they are really happy, they may bloom more often</li>
                <li>Carnations are “Flowers of God”! How? The scientific name of Carnation is “Dianthus caryophyllus”</li>
              </ul>
            </div>
          </fieldset>
        </div>
