<html>
    <head>
        <link rel="stylesheet" href="15regaldesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="15-regal-carnations-basket_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="15-regal-carnations-basket_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <ii><img id="2" class="thumb_normal" src="15-regal-carnations-basket_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <ii><img id="3" class="thumb_normal" src="15-regal-carnations-basket_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <ii><img id="4" class="thumb_normal" src="15-regal-carnations-basket_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">15 Regal Carnations</div><br><br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>15 Red Carnations</li>
                <li>Green Leaves</li>
                <li>Arranged in a Cane Basket- 6 inches</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Carnations are known as 'The flower of January'! Each color of carnation has specific meaning.</li>
                <li>Red Carnations represent admiration and adoration.</li>
              </ul>
            </div>
          </fieldset>
        </div>
