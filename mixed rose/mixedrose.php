<html>
    <head>
        <link rel="stylesheet" href="mixedrosedesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="mixed-roses-bunch_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="mixed-roses-bunch_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="mixed-roses-bunch_2.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Mixed Rose Bunch </div><br><br><br>
          ...
          59 Reviews</div><br>
          <div class="price">₹<div class="number">949</div></div>
