<html>
    ...
    <?php require_once("../index.php")?>
        ...
        <div class="navbar" style="font-family:Ubuntu;">
            <ul>
              <li><a href="needtoday.php"><svg width="20px" height="20px" viewBox="0 0 16 16" class="bi bi-clock" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <div style="width:1520px; height:28px; background-color: orange;">
        <marquee style="font-family:Ubuntu; color: white; font-size:25px;">2 Hours Gauranteed Delivery &nbsp; | &nbsp; Free Shipping &nbsp; | &nbsp; Hassle Free Delivery &nbsp;| &nbsp; Wide Range Of Gifts &nbsp;|</marquee>
        </div>
        <br>
