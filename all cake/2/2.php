<html>
    <head>
        <link rel="stylesheet" href="2.design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="designer-blue-chocolate-gift-cake-1-kg_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="designer-blue-chocolate-gift-cake-1-kg_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="designer-blue-chocolate-gift-cake-1-kg_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="designer-blue-chocolate-gift-cake-1-kg_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Blue Chocolate Cake</div><br><br><br>
          ...
          59 Reviews</div><br>
          <div class="price">₹<div class="number">1440</div></div>
          <div class="discount"><del>₹1800</del></div>
