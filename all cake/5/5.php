<html>
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="kit-kat-cake-half-kg_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="kit-kat-cake-half-kg_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="kit-kat-cake-half-kg_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="kit-kat-cake-half-kg_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Kit Kat Cake</div><br><br><br>
          ...
          97 Reviews</div><br>
          <div class="price">₹<div class="number">1145</div></div>
          <div class="discount"><del>₹1100</del></div>
