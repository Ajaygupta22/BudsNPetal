<html>
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="walnut-cinnamon-cake-half-kg_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="walnut-cinnamon-cake-half-kg_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="walnut-cinnamon-cake-half-kg_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="walnut-cinnamon-cake-half-kg_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Walnut Cinnamon Cake</div><br><br><br>
          ...
          68 Reviews</div><br>
          <div class="price">₹<div class="number">1100</div></div>
          <div class="discount"><del>₹1300</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Cake Flavour- Walnut Cinnamon</li>
                <li>Weight- 1 Kg</li>
