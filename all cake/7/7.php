<html>
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="blueberry-glaze-cake-half-kg_2.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="blueberry-glaze-cake-half-kg_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="blueberry-glaze-cake-half-kg_4.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="blueberry-glaze-cake-half-kg_5.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Blueberry Glaze Cake</div><br><br><br>
          ...
          65 Reviews</div><br>
          <div class="price">₹<div class="number">810</div></div>
