<html>
    <head>
        <link rel="stylesheet" href="pinkrosedesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="15-pink-roses-vase-arrangement_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="15-pink-roses-vase-arrangement_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="15-pink-roses-vase-arrangement_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="15-pink-roses-vase-arrangement_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Pink Roses </div><br><br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>You can reuse the vase once the flowers wither away. It can be used as a desk pen holder or to store your knick knacks.</li>
