<html>
    <head>
        <link rel="stylesheet" href="yellowrosesdesign.css">
    ...
    <body>
        ...
        <div class="margin">
            <img id="0" src="shining-yellow-roses-bunch_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="shining-yellow-roses-bunch_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <ii><img id="2" class="thumb_normal" src="shining-yellow-roses-bunch_2.webp" onmouseover="preview(this)"/></ii>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Yellow Roses</div><br><br><br>
          ...
          101 Reviews</div><br>
          <div class="price">₹<div class="number">1699</div></div>
          <div class="discount"><del>₹1999</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                ...
                <li>Wrapped in Non Woven Paper</li>
                <li>Tied Beautifully</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Did you know a rose bush can grow quite tall? The tallest ever recorded rose bush stands at over 23 feet (7 meters) tall!</li>
                <li>Yellow Roses signify friendship & are perfect for expressing friendly feelings towards someone!</li>
              </ul>
            </div>
          </fieldset>
        </div>
