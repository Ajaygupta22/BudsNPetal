<html>
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="chlorophytum-plant-ganesha-idol-combo_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="chlorophytum-plant-ganesha-idol-combo_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="chlorophytum-plant-ganesha-idol-combo_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="chlorophytum-plant-ganesha-idol-combo_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Chlorophytum Plant</div><br><br><br>
          ...
          89 Reviews</div><br>
          <div class="price">₹<div class="number">959</div></div>
          <div class="discount"><del>₹1200</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>One Chlorophytum Plant- Upto 5 inches</li>
                <li>Plant Type- Foliage/Air Purifying</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Handle idol with care</li>
                <li>Clean with soft and dry cloth only</li>
              </ul>
            </div>
          </fieldset>
        </div>
