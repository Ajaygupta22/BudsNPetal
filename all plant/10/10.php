<html>
    <head>
        <link rel="stylesheet" href="10design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="jade-plant-terrarium-in-glass-vase_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="jade-plant-terrarium-in-glass-vase_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="jade-plant-terrarium-in-glass-vase_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="jade-plant-terrarium-in-glass-vase_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Jade Plant</div><br><br><br>
          ...
          65 Reviews</div><br>
          <div class="price">₹<div class="number">720</div></div>
          <div class="discount"><del>₹800</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Origin- It originates from South Africa, but it can be found in temperate regions all over the world today</li>
                <li>Jade Plant is a perennial plant. It has a life span of more than 2 years. It is a low-maintenance succulent with delicate pink or white flowers that bloom in the spring</li>
              </ul>
            </div>
          </fieldset>
        </div>
