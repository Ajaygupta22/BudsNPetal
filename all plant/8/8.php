<html>
    <head>
        <link rel="stylesheet" href="8design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="green-ficus-dwarf-beauty-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="green-ficus-dwarf-beauty-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="green-ficus-dwarf-beauty-plant_2.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Ficus Dwarf Plant</div><br><br><br>
          ...
          59 Reviews</div><br>
          <div class="price">₹<div class="number">809</div></div>
          <div class="discount"><del>₹899</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- Ficus Dwarf Plant</li>
                <li>Plant Type- Air Purifying Plant</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Origin- Ficus benjamina, commonly known as weeping fig, or Ficus tree is native to Asia and Australia.</li>
