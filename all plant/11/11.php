<html>
    <head>
        <link rel="stylesheet" href="11design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="gorgeous-salvia-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="gorgeous-salvia-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="gorgeous-salvia-plant_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="gorgeous-salvia-plant_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Gorgeous Salvia Plant</div><br><br><br>
          ...
          55 Reviews</div><br>
          <div class="price">₹<div class="number">540</div></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Another name for the perennial Salvia plant is "Sage"</li>
                <li>Salvia Plant flowers have a soothing and healing fragrance, and has been used in ritualistic practices since centuries</li>
              </ul>
            </div>
          </fieldset>
        </div>
