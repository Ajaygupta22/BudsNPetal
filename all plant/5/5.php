<html>
    <head>
        <link rel="stylesheet" href="5design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="flowering-guldaudi-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="flowering-guldaudi-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="flowering-guldaudi-plant_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="flowering-guldaudi-plant_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Flowering Guldaudi Plant</div><br><br><br>
          ...
          67 Reviews</div><br>
          <div class="price">₹<div class="number">569</div></div>
          <div class="discount"><del>₹600</del></div>
          <div class="percent">5% discount</div>
          <br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- Guldaudi</li>
                <li>Plant Type- Flowering</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Better known as Chrysanthemum, the Guldaudi Plant is a very popular flowering plant, specially due to its beautiful blossoms</li>
                <li>Apart from being a decorative plant, Chrysanthemum blossoms are used to make Chrysanthemum tea which is in great demand</li>
              </ul>
            </div>
          </fieldset>
        </div>
