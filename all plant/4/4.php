<html>
    <head>
        <link rel="stylesheet" href="4design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="green-pot-of-sansevieria-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="green-pot-of-sansevieria-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="green-pot-of-sansevieria-plant_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="green-pot-of-sansevieria-plant_5.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Sansevieria Plant</div><br><br><br>
          ...
          87 Reviews</div><br>
          <div class="price">₹<div class="number">680</div></div>
          <div class="discount"><del>₹800</del></div>
          <div class="percent">15% discount</div>
          <br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Sansivieria also known as Birds Nest Snake Plant an excellent plant for purifying the air and removing toxins</li>
                <li>It can grow up to 8 inches tall and its foliage is arranged in an attractive rosette</li>
              </ul>
            </div>
          </fieldset>
        </div>
