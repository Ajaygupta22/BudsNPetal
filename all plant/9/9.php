<html>
    <head>
        <link rel="stylesheet" href="9design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="pot-of-mini-aloe-vera-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="pot-of-mini-aloe-vera-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="pot-of-mini-aloe-vera-plant_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="pot-of-mini-aloe-vera-plant_5.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Mini Aloe Vera Plant</div><br><br><br>
          ...
          87 Reviews</div><br>
          <div class="price">₹<div class="number">719</div></div>
          <div class="discount"><del>₹799</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- Mini Aloe Vera Plant</li>
                <li>Plant Type- Succulent/Air Purifying</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Origin- Aloe Vera originates from the Arabian Peninsula but grows wild in tropical climates around the world</li>
                <li>Aloe Vera is a multipurpose plant that benefits health and skin in many ways. It is also found in many cosmetics, skin lotions, and ointments</li>
              </ul>
            </div>
          </fieldset>
        </div>
