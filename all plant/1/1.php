<html>
    <head>
        <link rel="stylesheet" href="1design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="money-plant-in-purple-ceramic-pot_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="money-plant-in-purple-ceramic-pot_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="money-plant-in-purple-ceramic-pot_4.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="money-plant-in-purple-ceramic-pot_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Money Plant</div><br><br><br>
          ...
          68 Reviews</div><br>
          <div class="price">₹<div class="number">399</div></div>
          <div class="discount"><del>₹499</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- Golden Money Plant</li>
                <li>Plant Type- Air Purifying Foliage</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Money plants are considered as a lucky plant known to bring wealth, health, prosperity and happiness in the house.</li>
                <li>Money plant seeds can be consumed. It is said that they taste like peanuts.</li>
              </ul>
            </div>
          </fieldset>
        </div>
