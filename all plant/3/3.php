<html>
    <head>
        <link rel="stylesheet" href="3design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="milt-sansevieria-in-a-white-ceramic-pot_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="milt-sansevieria-in-a-white-ceramic-pot_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="milt-sansevieria-in-a-white-ceramic-pot_4.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="milt-sansevieria-in-a-white-ceramic-pot_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">MILT Sansevieria Plant</div><br><br><br>
          ...
          78 Reviews</div><br>
          <div class="price">₹<div class="number">900</div></div>
          <div class="discount"><del>₹1000</del></div>
          <div class="percent">10% discount</div>
          <br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- MILT Sansevieria Plant</li>
                <li>Plant Type- Air Purifying Succulent</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Origin: MILT Sansevieria is a species in the family Asparagaceae, native to tropical West Africa from Nigeria east to the Congo</li>
                <li>This plant is one of the best for filtering out formaldehyde, which is common in cleaning products, toilet paper, tissues and personal care products</li>
              </ul>
            </div>
          </fieldset>
        </div>
