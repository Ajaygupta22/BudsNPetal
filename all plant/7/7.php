<html>
    <head>
        <link rel="stylesheet" href="7design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="hoya-plant-in-sheesham-wood-planter_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="hoya-plant-in-sheesham-wood-planter_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="hoya-plant-in-sheesham-wood-planter_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="hoya-plant-in-sheesham-wood-planter_5.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Hoya Plant</div><br><br><br>
          ...
          <div class="discount"><del>₹1500</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- Hoya Plant</li>
                <li>Plant Type- Cacti & Succulents</li>
                <li>Plant Placement- Table Top</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Beautiful planter with minimalistic design</li>
                <li>Sheesham wood carving for a smooth & classy finish</li>
              </ul>
            </div>
          </fieldset>
        </div>
