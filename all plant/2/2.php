<html>
    <head>
        <link rel="stylesheet" href="2design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="potted-coleus-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="potted-coleus-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="potted-coleus-plant_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="potted-coleus-plant_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Potted Coleus Plant</div><br><br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Plant Name- Coleus</li>
                <li>Plant Type- Foliage</li>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Coleus Plant belongs to the mint family</li>
                <li>Varieties of common coleus, or painted nettle from Java, are well-known house and garden plants up to one metre (three feet) tall</li>
              </ul>
            </div>
          </fieldset>
        </div>
