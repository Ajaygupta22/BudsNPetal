<html>
    <head>
        <link rel="stylesheet" href="12design.css">
    ...
    <?php require_once("../../index.php")?>
        ...
        <div class="margin">
            <img id="0" src="flowering-marigold-plant_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="flowering-marigold-plant_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="flowering-marigold-plant_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="flowering-marigold-plant_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Flowering Marigold Plant</div><br><br><br>
          ...
          59 Reviews</div><br>
          <div class="price">₹<div class="number">850</div></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Marigolds come in a variety of colors such as orange, red, maroon, yellow or even mixed!</li>
                <li>Marigold leaves and flowers possess a good insect repelling abilities, and works wonderfully to keep away flies, ants and mosquitoes</li>
              </ul>
            </div>
          </fieldset>
        </div>
