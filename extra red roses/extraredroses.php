<html>
    <head>
        <link rel="stylesheet" href="extraredrosesdesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="extravagant-40-red-roses-arrangement_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="extravagant-40-red-roses-arrangement_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="extravagant-40-red-roses-arrangement_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="extravagant-40-red-roses-arrangement_3.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Extravagant Red Roses </div><br><br><br>
          ...
          86 Reviews</div><br>
          <div class="price">₹<div class="number">1665</div></div>
          <div class="discount"><del>₹1849</del></div>
