<html>
    <head>
        <link rel="stylesheet" href="redpinkdesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="roses-carnations-in-glass-vase_2.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="roses-carnations-in-glass-vase_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="roses-carnations-in-glass-vase_3.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="roses-carnations-in-glass-vase_4.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Red & Pink Roses </div><br><br><br>
          ...
          80 Reviews</div><br>
          <div class="price">₹<div class="number">1200</div></div>
          <div class="discount"><del>₹1449</del></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>19 Dark Pink Roses</li>
                <li>20 Light Pink Roses</li>
                <li>10 Light Pink Carnations</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Origin- The rose is (according to fossil evidence) 35 million years old. Garden cultivation of roses began some 5,000 years ago, probably in China.</li>
