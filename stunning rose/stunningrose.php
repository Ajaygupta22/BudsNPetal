<html>
    <head>
        <link rel="stylesheet" href="stunningrosedesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="stunning-rose-arrangement_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="stunning-rose-arrangement_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="stunning-rose-arrangement_2.webp" onmouseover="preview(this)"/> </li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Stunning Rose </div><br><br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Did you know that the rose is edible has been mentioned in the bible and is a great source of vitamin C?</li>
