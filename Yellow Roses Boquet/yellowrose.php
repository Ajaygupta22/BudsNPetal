<html>
    <head>
        <link rel="stylesheet" href="yellowrosedesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="yellow-roses-basket-arrangement_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="yellow-roses-basket-arrangement_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="yellow-roses-basket-arrangement_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="yellow-roses-basket-arrangement_3.webp" onmouseover="preview(this)"/></li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Yellow Roses Boquet</div><br><br><br>
          ...
          92 Reviews</div><br>
          <div class="price">₹<div class="number">899</div></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>27 Yellow Roses</li>
                <li>Seasonal Green Fillers</li>
                <li>Arranged in a Basket</li>
              </ul>
            </div>
          </fieldset>
          <br><br>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>Did you know that the rose is edible, can live for a very long time, has been mentioned in the bible and is a great source of vitamin C?</li>
                <li>A rose fossil was found in Colorado with the age of about 35 million years. Maybe they should call it a vintage rose?</li>
              </ul>
            </div>
          </fieldset>
        </div>
