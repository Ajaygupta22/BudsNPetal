<html>
    <head>
        <link rel="stylesheet" href="exoticredrosedesign.css">
    ...
    <?php require_once("..\index.php")?>
        ...
        <div class="margin">
            <img id="0" src="10-red-roses-exotic-bouquet_1.webp" class="image"><br>
            <ul class="thumbnail">
                <li><img id="1" class="thumb_normal" src="10-red-roses-exotic-bouquet_1.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="2" class="thumb_normal" src="10-red-roses-exotic-bouquet_2.webp" onmouseover="preview(this)"/> &nbsp;&nbsp;</li>
                <li><img id="3" class="thumb_normal" src="10-red-roses-exotic-bouquet_3.webp" onmouseover="preview(this)"/></li>
            </ul>
        </div>
        
        <div class="info">
          <div class="item_name">Exotic Red Roses</div><br><br><br>
          ...
          142 Reviews</div><br>
          <div class="price">₹<div class="number">760</div></div>
          ...
          <fieldset>
            ...
            <div class="inside_legend">
              <ul>
                <li>The famous Cleopatra of Egypt was believed to have covered the floor of her palace room with roses before Mark Antony visited her</li>
                <li>It grows on the wall of the Cathedral of Hildesheim in Germany and its presence is documented since A.D. 815!</li>
              </ul>
            </div>
          </fieldset>
        </div>
